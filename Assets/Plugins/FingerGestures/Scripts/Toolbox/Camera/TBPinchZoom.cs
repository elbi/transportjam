        ...
        set
        {
            ...
            switch( zoomMethod )
            {
                case ZoomMethod.Position:
                    transform.localPosition = defaultPos + zoomAmount * transform.forward;
					transform.localPosition = new Vector3(defaultPos.x, transform.localPosition.y, defaultPos.z);
                    break;
